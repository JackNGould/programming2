 ...
 * @file: Node.h
 * @author: Jack Gould
 * @brief: Header file for templated Node class. Lists member methods. Used for a node based implementation of a Queue. Used for command input list and elevator line
 * @date: 02-19-2020
 */
#ifndef NODE_H
#define NODE_H
